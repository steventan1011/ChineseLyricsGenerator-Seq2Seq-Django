...
class Encoder(nn.Module):
    ...
    def forward(self, input_seqs, input_lengths, hidden=None):
        ...
        packed = nn.utils.rnn.pack_padded_sequence(input_seqs, sorted(input_lengths, reverse=True), batch_first=True)
...
class Decoder(nn.Module):
    ...
    def forward(self, input_seqs, input_lengths, encoder_outputs, encoder_length, hidden=None):
        ...
        packed = nn.utils.rnn.pack_padded_sequence(input_seqs, input_lengths, batch_first=True)
